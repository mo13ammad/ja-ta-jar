  ...
  useEffect(() => {
    if (houseData) {
      ...
      setFormData({
        ...
        selectedRoutes:
          houseData?.arrivals?.types?.map((route) => route.key) || [],
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-2 lg:gap-4">
                ...
                >
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <Switch
                      ...
                      onChange={() =>
                        toggleOption(option.key, "selectedTextures")
                      }
          ...
          <div className="mt-4 lg:col-span-2">
            <TextArea
              ...
              onChange={(e) =>
                handleInputChange("viewDescription", e.target.value)
              }
                ...
                >
                  <label className="flex items-center space-x-2 cursor-pointer">
                    <Switch
                      ...
                      onChange={() =>
                        toggleOption(option.key, "selectedRoutes")
                      }
                      className={`relative inline-flex items-center h-6 w-6 rounded-full transition-colors ease-in-out duration-200 ml-1 ${
          ...
          <div className="mt-4 lg:col-span-2">
            <TextArea
              ...
              onChange={(e) =>
                handleInputChange("accessMethod", e.target.value)
              }
