...
const sections = [
  { label: "آدرس و موقعیت مکانی", keys: ["address", "location"], icon: <LocationIcon /> },
  { label: "اطلاعات کلی", keys: ["generalInfo", "environmentInfo"], icon: <DetailsIcon /> },
  { label: "مشخصات اقامتگاه", keys: ["rooms", "bathrooms", "otherSpaces"], icon: <HouseIcon /> },
  { label: "امکانات", keys: ["mainFacilities", "kitchenEquipment", "specialServices"], icon: <EquipmentIcon /> },
  { label: "قوانین اقامتگاه", keys: ["reservationRules", "stayRules"], icon: <RulesIcon /> },
  { label: "قیمت گذاری", keys: ["pricing"], icon: <PricingIcon /> },
  { label: "تصاویر اقامتگاه", keys: ["images"], icon: <ImageIcon /> },
  { label: "اطلاعات فردی", keys: ["personalInfo"], icon: <PersonalDetailsIcon /> },
            ...
            <Disclosure key={section.label}>
              {({ open }) => (
                <>
                  ...
                  <Disclosure.Panel className="pr-8 pb-2 text-sm text-gray-800 w-full">
