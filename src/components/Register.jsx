...
import { Circles } from 'react-loader-spinner'; // Correct import for the spinner

const API_BASE_URL = "http://jatajar.viraup.com/api/auth";
      ...
      <div className="flex justify-center items-center text-right h-screen w-80 sm:w-96 mx-auto">
        <div className="rounded-2xl p-8 bg-gray-50 shadow-sm">
          <form onSubmit={handleOtpSubmit} >
            ...
            {loading && <Circles height="80" width="80" color="#4fa94d" ariaLabel="circles-loading" />}
